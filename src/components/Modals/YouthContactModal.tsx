          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input 
                ...
                placeholder="info@youthkapakistan.com"
                className="w-full bg-[#F9FAFB] border border-gray-300 rounded-xl px-3.5 py-2.5 text-sm text-[#111827] focus:outline-none focus:border-[#05472A]"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#05472A] hover:bg-[#03311d] text-white font-extrabold text-xs uppercase tracking-wider py-3.5 rounded-full shadow-md transition-all cursor-pointer flex items-center justify-center gap-2"
            >
